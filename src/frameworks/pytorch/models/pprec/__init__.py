"""PP-Rec (PyTorch) — folder-style model.
...
# Backward-compatibility aliases — TCCM and any external code can keep
# importing PPRecNewsEncoder / PPRecUserEncoder from this package.
