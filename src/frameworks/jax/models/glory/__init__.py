"""GLORY (Flax NNX) — folder-style model.
...
Layout:
    ...
    global_encoder.py — GatedGraphConv (pure-JAX GGNN) + GRUCell +
                        EntityEncoder and GlobalEntityEncoder (built
                        when use_entity=True)
